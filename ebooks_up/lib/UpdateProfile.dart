        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children:[
              ...
              const Text('Update Name',style: TextStyle(color: Color(0xffb3b3b3),fontWeight:FontWeight.bold,fontSize: 18),),
...
onChanged: (value){
                ...
                decoration: InputDecoration(
                  hintText: 'Enter name',labelStyle: const TextStyle(color: Color(0xff212121),),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  width: 122,
                  child: TextButton(
                    child:btntitle==0?const Text('Change',style: TextStyle(fontSize: 18,color: Colors.white,fontWeight: FontWeight.w400),):Container(width: 15,height: 25,child: const CircularProgressIndicator(color: Colors.white,),),
                    onPressed: () {
                      user.setName(name.toString());
                      showDialog(context: context, builder: (context)
                      {
                        return AlertDialog(content: const Text("Name is updated."),
                      actions: [
              ...
              const Text('Update Password',style: TextStyle(color: Color(0xffb3b3b3),fontWeight:FontWeight.bold,fontSize: 18),),
              const SizedBox(height: 20,),
              TextField(textAlign: TextAlign.start,
              ...
              TextField(textAlign: TextAlign.start,
                ...
                decoration: InputDecoration(
                  ...
                  Icons.visibility_off_outlined),color: const Color(0xffb3b3b3),),
                  hintText: 'Confirm Password',labelStyle: const TextStyle(color: Color(0xff212121),fontStyle: FontStyle.italic),
                  hintStyle:const TextStyle(fontSize: 12,),
                  enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(20),
                    borderSide:const BorderSide(
