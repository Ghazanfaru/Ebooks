...
class AudiableBooks extends StatelessWidget {
  ...
  final List<AudioBookModel> BookData=List.generate(Bookname.length,
          (index) =>
          AudioBookModel(Bookname[index], Category[index],Author[index],imgpath[index],Description[index]));
      ...
      body: SingleChildScrollView(
        child: Column(
            children: [
                        ...
                        children: [
                          InkWell(child: Container(child: Column(
                            children: [
                              ...
                              Text(BookData[index].Bookname,style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                          ...
                          Text(BookData[index].Category,style: TextStyle(fontSize: 13,fontWeight: FontWeight.w400),),
                          const SizedBox(height: 2,),
                          Text(BookData[index].Author,style: TextStyle(fontSize: 11,fontWeight: FontWeight.w300),),
                          const SizedBox(height: 2,),
                          const Rating(),
                        ],
                      ),
              ...
              const TextButtons(text: 'This Week', btntxt: 'More',),
